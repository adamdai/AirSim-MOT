...
from lib.datasets.airsim_rcnn_dataset import AirSimRCNNDataset
...
def create_dataloader(logger):
    ...
    elif cfg.DATASET == 'AirSim': 
        train_set = AirSimRCNNDataset(root_dir=DATA_PATH, npoints=cfg.RPN.NUM_POINTS, split=cfg.TRAIN.SPLIT, mode='TRAIN',
                                    logger=logger,
                                    classes=cfg.CLASSES,
                                    rcnn_training_roi_dir=args.rcnn_training_roi_dir,
                                    rcnn_training_feature_dir=args.rcnn_training_feature_dir,
    ...
    if args.train_with_eval:
        if cfg.DATASET == 'KITTI':
            ...
            test_set = AirSimRCNNDataset(root_dir=DATA_PATH, npoints=cfg.RPN.NUM_POINTS, split=cfg.TRAIN.VAL_SPLIT, mode='EVAL',
                                        logger=logger,
                                        classes=cfg.CLASSES,
                                        rcnn_eval_roi_dir=args.rcnn_eval_roi_dir,
                                        rcnn_eval_feature_dir=args.rcnn_eval_feature_dir)
