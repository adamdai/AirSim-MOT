...
class AirSimDataset(torch_data.Dataset):
    def __init__(self, root_dir, split='train'):
        self.split = split
        is_test = self.split == 'test'
        self.imageset_dir = os.path.join(root_dir, 'AirSim', 'object', 'testing' if is_test else 'training')

        split_dir = os.path.join(root_dir, 'AirSim', 'ImageSets', split + '.txt')
